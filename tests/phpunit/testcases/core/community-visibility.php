...
class BP_Tests_BP_Community_Visibility_TestCases extends BP_UnitTestCase {
	...
	public function test_bp_community_visibility_allow_visibility_for_logged_in_user() {
		$this->assertTrue( bp_user_can( $this->logged_in_user, 'bp_read', array( 'bp_component' => 'members' ) ) );
		$this->assertTrue( bp_user_can( $this->logged_in_user, 'bp_read', array( 'bp_component' => 'groups' ) ) );
	}
	...
	public function test_bp_community_visibility_enforce_visibility_for_anon_user() {
		$this->assertTrue( bp_user_can( 0, 'bp_read', array( 'bp_component' => 'members' ) ) );
		$this->assertFalse( bp_user_can( 0, 'bp_read', array( 'bp_component' => 'groups' ) ) );
	}

	// No component or bad component should be open.
	public function test_bp_community_visibility_bad_component_id() {
		$this->assertTrue( bp_user_can( 0, 'bp_read' ) );
		$this->assertTrue( bp_user_can( $this->logged_in_user, 'bp_read' ) );
		$this->assertTrue( bp_user_can( 0, 'bp_read', array( 'bp_component' => 'blerg' ) ) );
		$this->assertTrue( bp_user_can( $this->logged_in_user, 'bp_read', array( 'bp_component' => 'blerg' ) ) );
	}
	...
	public function test_bp_community_visibility_no_saved_setting() {
		...
		$this->assertTrue( bp_user_can( 0, 'bp_read', array( 'bp_component' => 'groups' ) ) );
		$this->assertTrue( bp_user_can( $this->logged_in_user, 'bp_read', array( 'bp_component' => 'groups' ) ) );
	}
