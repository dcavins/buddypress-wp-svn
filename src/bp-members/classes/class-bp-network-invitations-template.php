<?php
/**
 * BuddyPress Network_Invitation Template Loop Class.
 *
 * @package BuddyPress
 ...
 * @since 1.9.0
 */
class BP_Network_Invitations_Template {
	 ...
	 * Constructor method.
	 *
	 * @see bp_has_network_invitations() For information on the array format.
	 *
	 * @since 1.9.0
	 *
	 * @param array $args {
	 *     An array of arguments. See {@link bp_has_network_invitations()}
	 *     for more details.
	 * }
	 */
	 ...
	 * @since 1.9.0
	 *
	 * @see bp_has_network_invitations()
	 *
