...
/**
 * Initialize the network invitations loop.
 *
 ...
 * @return bool
 */
function bp_has_network_invitations( $args = '' ) {
	...
	$r = bp_parse_args( $args, array(
		...
		'page_arg'          => 'ipage',
	), 'has_network_invitations' );

	// Get the notifications.
	$query_loop = new BP_Network_Invitations_Template( $r );

	// Setup the global query loop.
	buddypress()->network_invitations->query_loop = $query_loop;
	 ...
	 * @param BP_Notifications_Template $query_loop BP_Network_Invitations_Template object instance.
	 * @param array                     $r          Array of arguments passed into the BP_Network_Invitations_Template class.
	 */
	return apply_filters( 'bp_has_network_invitations', $query_loop->has_invitations(), $query_loop, $r );
}
...
function bp_the_network_invitations() {
	return buddypress()->network_invitations->query_loop->invitations();
}
...
function bp_the_network_invitation() {
	return buddypress()->network_invitations->query_loop->the_invitation();
}
 ...
 * @since 7.0.0
 */
function bp_network_invitations_pagination_count() {
	echo bp_get_network_invitations_pagination_count();
}
	/**
	 ...
	 */
	function bp_get_network_invitations_pagination_count() {
		$query_loop = buddypress()->network_invitations->query_loop;
		 ...
		 */
		return apply_filters( 'bp_network_invitations_pagination_count', $pag );
	}
 ...
 * @since 7.0.0
 */
function bp_network_invitations_pagination_links() {
	echo bp_get_network_invitations_pagination_links();
}
	/**
	 ...
	 */
	function bp_get_network_invitations_pagination_links() {
		 ...
		 */
		return apply_filters( 'bp_get_network_invitations_pagination_links', buddypress()->network_invitations->query_loop->pag_links );
	}
 ...
 * @since 7.0.0
 */
function bp_the_network_invitation_property( $property ) {
	echo bp_get_the_network_invitation_property( $property );
}
	/**
	 ...
	 */
	function bp_get_the_network_invitation_property( $property = 'id' ) {
		...
		if ( isset( buddypress()->network_invitations->query_loop->invitation->{$property} ) ) {
			$value = buddypress()->network_invitations->query_loop->invitation->{$property};
		}
		 ...
		 */
		return apply_filters( 'bp_get_the_network_invitation_property_' . $property, $value );
	}
 ...
 */
function bp_the_network_invitation_action_links( $args = '' ) {
	echo bp_get_the_network_invitation_action_links( $args );
}
	/**
	 ...
	 */
	function bp_get_the_network_invitation_action_links( $args = '' ) {
		...
		$r = wp_parse_args( $args, array(
			...
			'sep'    => ' | ',
			'links'  => array(
				bp_get_the_network_invitation_resend_link( $inviter_id ),
				bp_get_the_network_invitation_delete_link( $inviter_id )
			)
		) );
		 ...
		 * @param array  $r      Array of parsed arguments.
		 */
		return apply_filters( 'bp_get_the_network_invitation_action_links', $retval, $r );
	}
 ...
 */
function bp_the_network_invitation_resend_link( $user_id = 0 ) {
	echo bp_get_the_network_invitation_delete_link( $user_id );
}
	/**
	 ...
	 * @return string
	 */
	function bp_get_the_network_invitation_resend_link( $user_id = 0 ) {
		// Set default user ID to use.
		$user_id = 0 === $user_id ? bp_displayed_user_id() : $user_id;

		// Don't allow resending of accepted invitations.
		if ( bp_get_the_network_invitation_property( 'accepted' ) ) {
			return;
		}

		$retval = sprintf( '<a href="%1$s" class="resend secondary confirm bp-tooltip">%2$s</a>', esc_url( bp_get_the_network_invitation_resend_url( $user_id ) ), __( 'Resend', 'buddypress' ) );
		 ...
		 * @param int    $user_id The user ID.
		 */
		return apply_filters( 'bp_get_the_network_invitation_resend_link', $retval, $user_id );
	}
 ...
 * @param int $user_id The user ID.
 */
function bp_the_network_invitation_resend_url( $user_id = 0 ) {
	echo esc_url( bp_get_the_network_invitation_resend_url( $user_id ) );
}
	/**
	 ...
	 * @return string
	 */
	function bp_get_the_network_invitation_resend_url( $user_id = 0 ) {
		// Set default user ID to use.
		$user_id = 0 === $user_id ? bp_displayed_user_id() : $user_id;
		$link = bp_get_network_invitations_list_invites_permalink( $user_id );

		// Get the ID.
		$id = bp_get_the_network_invitation_property( 'id' );
		 ...
		 * @param int    $user_id The user ID.
		 */
		return apply_filters( 'bp_get_the_network_invitation_resend_url', $url, $user_id );
	}
 ...
 * @param int $user_id The user ID.
 */
function bp_the_network_invitation_delete_link( $user_id = 0 ) {
	echo bp_get_the_network_invitation_delete_link( $user_id );
}
	/**
	 ...
	 * @return string
	 */
	function bp_get_the_network_invitation_delete_link( $user_id = 0 ) {
		// Set default user ID to use.
		$user_id = 0 === $user_id ? bp_displayed_user_id() : $user_id;
		...
		$retval = sprintf( '<a href="%1$s" class="delete secondary confirm bp-tooltip">%2$s</a>', esc_url( bp_get_the_network_invitation_delete_url( $user_id ) ), $message );
		 ...
		 * @param int    $user_id The user ID.
		 */
		return apply_filters( 'bp_get_the_network_invitation_delete_link', $retval, $user_id );
	}
 ...
 * @param int $user_id The user ID.
 */
function bp_the_network_invitation_delete_url( $user_id = 0 ) {
	echo esc_url( bp_get_the_network_invitation_delete_url( $user_id ) );
}
	/**
	 ...
	 * @return string
	 */
	function bp_get_the_network_invitation_delete_url( $user_id = 0 ) {
		// Set default user ID to use.
		$user_id = 0 === $user_id ? bp_displayed_user_id() : $user_id;
		$link = bp_get_network_invitations_list_invites_permalink( $user_id );
		...
		// Add the nonce.
		$url = wp_nonce_url( $url, 'bp_network_invitation_cancel_' . $id );
		 ...
		 * @param int    $user_id The user ID.
		 */
		return apply_filters( 'bp_get_the_network_invitation_delete_url', $url, $user_id );
	}
 ...
 * @param int $user_id The user ID.
 */
function bp_network_invitations_list_invites_permalink( $user_id = 0 ) {
	echo bp_get_network_invitations_list_invites_permalink( $user_id );
}
	/**
	 ...
	 */
	function bp_get_network_invitations_list_invites_permalink( $user_id = 0 ) {
		if ( 0 === $user_id ) {
			$user_id = bp_loggedin_user_id();
		 ...
		 * @param int    $user_id The user ID.
		 */
		return apply_filters( 'bp_get_network_invitations_list_invites_permalink', $retval, $user_id );
	}
 ...
 * @param int $user_id The user ID.
 */
function bp_network_invitations_send_invites_permalink( $user_id = 0 ) {
	echo bp_get_network_invitations_send_invites_permalink( $user_id );
}
	/**
	 * Return the read notifications permalink.
	 *
	 ...
	 * @return string Read notifications permalink.
	 */
	function bp_get_network_invitations_send_invites_permalink( $user_id = 0 ) {
		if ( 0 === $user_id ) {
			$user_id = bp_loggedin_user_id();
			$domain  = bp_loggedin_user_domain();
		} else {
		 ...
		 * @param int    $user_id The user ID.
		 */
		return apply_filters( 'bp_get_network_invitations_send_invites_permalink', $retval, $user_id );
	}